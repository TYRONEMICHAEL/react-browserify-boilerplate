...
I modified the following [repo][thread](https://github.com/facebook/jest/issues/116) to use Browserify instead. I prefer writing my moduleds `Node Style` and having Browserfiy compile and bundle my app.
